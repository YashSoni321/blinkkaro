        ...
        <div className="max-w-c-1390 mx-auto px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Link Your Bookings, Tasks & Events — All in One Place.`,
              description: `Blinkkaro connects with your favorite tools like calendars, maps, and messaging apps to keep everything in sync. Get auto-reminders, real-time updates, and smooth coordination without switching between platforms.`,
            }}
          />
